...
const Form = () => {
    ...
    return (
        ...
        <form autoComplete="off" noValidate maxWidth="xs" className={`${classes.root} ${classes.form}`} onSubmit={handleSubmit}>
          <TextField name="device name" variant="outlined" half label="device name"handleChange={handleChange} />
          <br/>
          <br/>
